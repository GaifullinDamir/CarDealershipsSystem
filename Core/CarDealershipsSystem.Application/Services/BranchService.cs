...
namespace CarDealershipsSystem.Application.Services
{
    public class BranchService : IBranchService
    {
        ...
        {
            var branches = _branchRepository.GetBranchesWithCarsExemplars();
        ...
        {
            foreach (var branch in _branchRepository.GetBranches())
            {
                if (branch.BranchAddress == branchAddress)
                {
                    return true;
                }
            }
        ...
        {
            var branch = _branchRepository.GetBranchById(idBranch);
